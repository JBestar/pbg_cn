...
(function () {
  var PACKS = {
    ...
    en: {
      ...
      msg: {
        ...
        pointOk: 'Points converted',
        pointFail: 'Point conversion failed',
  ...
  function formatModeHtml(mode) {
    ...
    if (m >= 30 && m <= 39) {
      var digit = String(m - 30);
      return '<span class="bet-pb-ball" aria-label="' + digit + '">'
        + '<span class="bet-pb-ball-num">' + digit + '</span>'
        + '</span>';
    }
    var spec = map[m];
  ...
  var I18N = {
    keyMode: {
      ...
      Numpad0: 30, Numpad1: 31, Numpad2: 32, Numpad3: 33, Numpad4: 34,
      Numpad5: 35, Numpad6: 36, Numpad7: 37, Numpad8: 38, Numpad9: 39,
    },
