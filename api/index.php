    ...
    pbg_json([
        ...
        'data' => [
            ...
            'odds' => [
                ...
                30 => (float)$conf['ratio_23'],
                31 => (float)$conf['ratio_23'],
                32 => (float)$conf['ratio_23'],
                33 => (float)$conf['ratio_23'],
                34 => (float)$conf['ratio_23'],
                35 => (float)$conf['ratio_23'],
                36 => (float)$conf['ratio_23'],
                37 => (float)$conf['ratio_23'],
                38 => (float)$conf['ratio_23'],
                39 => (float)$conf['ratio_23'],
            ],
