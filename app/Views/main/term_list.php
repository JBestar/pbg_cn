        ...
        <div class="divSearch">
                ...
                <input type="date" id="inputDateS" value="<?php echo date('Y-m-d', strtotime('-1 month')); ?>" name="inputDateS" class="inputDate hasDatepicker">&nbsp;~&nbsp;
...
<?php if($_ENV['CI_ENVIRONMENT'] == ENV_PRODUCTION) :?>
    <script src="/assets/js/term_list.js?v=2"></script>
<?php else :?>
