    ...
    <div class="divSearch">
		...
		<form name="formSearch" method="get" action="/Main/sub_list">
            <input type="hidden" name="sub_level" value="4">    
        -->			
            ...
            <button class="btn_blue" style="float:right; margin-right:10px; padding:5px 10px;" onclick="showRegMember();"><?= lang('Admin.title_agency_reg') ?></button>
	</div>
    <div class="divList">
		...
		<table class="default_table">
			<thead>
                <tr>
                    ...
                    <th><?= lang('Admin.th_single_limit') ?></th>
                    <th><?= lang('Admin.th_mix_limit') ?></th>
            ...
            <tbody id="tbodyList">
                ...
                <tr style="background-color:#ffff00">
                    ...
                    <td class="tdDate">매장</td>
                    <td class="tdDate">여수</td>
                    
            
                    <td class="tdDate">여수1</td>
                    <td class="tdDate">여수1</td>
                    <td class="tdMoney">279,200</td>
                    <td class="tdMoney">0</td>
        
                    <td class="tdMoney">21,580,000</td>
                    <td class="tdMoney">16,202,500</td>
                    <td class="tdMoney">647,400</td>
                    <td class="tdMoney" style="color:#0000fe;">4,622,200</td>
                

                    <td class="tdMoney">5,000,000</td>
                    <td class="tdMoney">2,100,000</td>
                    <td class="tdMoney" style="color:#0000fe;">2,900,000</td>
                    <td class="tdMoney">2,100,000</td>
                    <td class="tdMoney">0</td>
                    <td class="tdDate">3.00 %&nbsp;/&nbsp;3.00 %</td>
                    <td class="tdDate">211.107.175.202</td>
                    
                    <td class="tdDate">
                        <button class="btn_red" onclick="chargeService(2203);">알충전</button>&nbsp;
                    </td>

                    <td class="tdDate">2021-10-10</td>
                </tr>
    ...
    <div id="divRegSub" style="position:absolute; left:calc(50% - 300px); top:100px; width:600px; border:1px solid #010101; background-color:#fefefe; display:none;">
		<div class="divTitle">매장등록</div>
        <div class="divInfoBox" style="line-height:34px; font-size:14px;">
            <table style="width:100%; border:0px;">
                <tbody>
                    <!--
                    <tr>
                        <td style="width:120px; border:0px;">상위관리자</td>
                        <td style="width:150px; border:0px;" colspan="2">
                            <select id="regSubParent">
                                <option value="">선택하세요</option>
                                <option value="여수">여수 (여수)&nbsp;&nbsp;단폴 : 3.00 %&nbsp;&nbsp;&nbsp;조합 : 3.00 %&nbsp;&nbsp;&nbsp;</option>
                            </select>
                        </td>
                    </tr>
                    -->
    ...
    <div class="divInfoBox" style="line-height:34px; font-size:14px;">
        ...
        <table style="width:100%; border:0px;">
            <tbody>
                <!--
                <tr>
                    <td style="width:140px; border:0px;">상위관리자</td>
                    <td style="width:130px; border:0px;" colspan="2">
                        <span id="editSubParent" style="font-weight:bold;"></span>
                    </td>
                </tr>
                -->
                <tr>
                ...
                <tr>
                    <td style="width:120px; border:0px;">회차한도</td>
                    <td style="width:150px; border:0px;"><input type="number" id="editSubTotalMaxBet" style="width:120px;"></td>
                    <td style="border:0px;"></td>
                </tr>
                <tr>
                    <td style="width:120px; border:0px;">단품한도</td>
                    <td style="width:150px; border:0px;"><input type="number" id="editSubSingleMaxBet" style="width:120px;"></td>
                    <td style="border:0px;"></td>
                </tr>
                <tr>
                    <td style="width:120px; border:0px;">조합한도</td>
                    <td style="width:150px; border:0px;"><input type="number" id="editSubMultiMaxBet" style="width:120px;"></td>
                    <td style="border:0px;"></td>
                </tr>
                <tr>
                    <td style="width:120px; border:0px;">3조합한도</td>
                    <td style="width:150px; border:0px;"><input type="number" id="editSubThreeMaxBet" style="width:120px;"></td>
                    <td style="border:0px;"></td>
                </tr>
                <tr>
                    <td style="width:120px; border:0px;">숫자한도</td>
                    <td style="width:150px; border:0px;"><input type="number" id="editSubDigitMaxBet" style="width:120px;"></td>
                    <td style="border:0px;"></td>
                </tr>
                <!--
                <tr>
                    <td style="width:120px; border:0px;">파워번호 최대배팅금액</td>
                    <td style="width:150px; border:0px;"><span type="text" id="editSubPowerNumMaxBet" style="width:120px;"></span></td>
                    <td style="border:0px;"></td>
                </tr>
                <tr>
                    <td style="width:120px; border:0px;">전체 최대배팅금액</td>
                    <td style="width:150px; border:0px;"><span type="text" id="editSubTotalMaxBet" style="width:120px;"></span></td>
                    <td style="border:0px;"></td>
                </tr>
                -->
                <tr>
...
<div id="divServiceExchange" style="position:absolute; left:calc(50% - 300px); top:150px; width:600px; border:1px solid #010101; background-color:#fefefe; display:none;">
    ...
    <div class="divInfoBox" style="height:190px; line-height:34px; font-size:14px;">
        ...
        <span id="serviceExchangeSenderId" style="position:absolute; left:100px; top:40px; font-weight:bold;">master(마스터)</span>
...
<script src="/assets/js/agency.js?v=1"></script>